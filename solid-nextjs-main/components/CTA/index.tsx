        ...
        <div className="mx-auto max-w-c-1390 rounded-lg bg-gradient-to-t from-[#F8F9FF] to-[#DEE7FF] px-7.5 py-12.5 dark:bg-blacksection dark:bg-gradient-to-t dark:from-transparent dark:to-transparent dark:stroke-strokedark md:px-12.5 xl:px-17.5 xl:py-0">
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              ...
              Partner with Algerie Telecom Today
              Boost Your Business Efficiencyin With Us Today & Increase Your Productivity
              </h2>
              <p>
              Join forces with Algerie Telecom and unlock the full potential of your business. Our cutting-edge hosting solutions are designed to enhance your productivity and drive success. Let’s grow together.
              </p>
            </motion.div>
            <motion.div
              variants={{
